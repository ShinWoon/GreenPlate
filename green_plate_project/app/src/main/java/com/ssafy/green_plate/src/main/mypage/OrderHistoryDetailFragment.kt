    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activityViewModel.clickedOrderHistoryItem.observe(viewLifecycleOwner) {
            ...
            binding.apply {
                ...
                orderHistoryTotalPriceTv.text = CommonUtils.makeComma(it[0].totalPrice)
                orderHistoryDiscountTv.text = CommonUtils.makeComma(it[0].discount)
                orderHistoryFinalPriceTv.text = CommonUtils.makeComma(it[0].totalPrice-it[0].discount)
